...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 112.0, 259.0, 72.0, 23.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 315.0, 139.0, 91.0, 22.0 ],
													"text" : "read \"snare 01\""
												}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 673.0, 300.0, 35.0, 22.0 ],
									"text" : "dac~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 159.0, 128.0, 79.0, 22.0 ],
									"text" : "phasor~ 1.66"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 99.0, 136.0, 51.0, 22.0 ],
									"text" : "pcontrol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 19.0, 141.0, 70.0, 22.0 ],
									"text" : "loadmess 0"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 102.022416979074478, 176.5, 56.0, 20.0 ],
									"text" : "Presets:",
									"textjustification" : 2
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 159.0, 177.0, 666.0, 19.0 ],
									"saved_attribute_attributes" : 									{
										"htabcolor" : 										{
...
,
									"tabs" : [ "Samba", "NI Grid (8|5, S=0.3, R=0)", "Turkish Aksak", "Cuban tresillo" ]
								}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 69.166687000000024, 677.0, 30.0, 30.0 ]
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 196.0, 280.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 196.0, 305.0, 183.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 672.0, 102.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 19.0, 54.0, 812.0, 103.0 ],
									"text" : "NI Grids are rhythmic structures created by shifting the beats of one isochronous pulse (the Formative pulse)  towards the beats of another (the Target pulse). For S = 0, the beats of the NI Grids are fully aligned with the Formative pulse. For S = 1, they are aligned with the Taarget pulse. The process creates a non-isochronous timing pattern with only two types of intervals: Long (L) and Short (S). These intervals are distributed as evenly as possible across the repetition cycle, and their arrangement can be rotated in different ways, defined by the rotation configuration R. NI Grids offer a compact and dynamic way to represent flexible rhythmic structures using just four parameters"
								}
...
,
					"patching_rect" : [ 147.0, 167.0, 76.0, 23.0 ],
					"text" : "p \"NI Grids\"",
					"varname" : "patcher"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 124.0, 798.0, 25.0, 22.0 ],
									"text" : "b 1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 124.0, 764.0, 77.0, 29.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 433.0, 47.0, 89.0, 30.0 ],
									"rounded" : 4.0,
									"saved_attribute_attributes" : 									{
										"textcolor" : 										{
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 614.0, 82.5, 54.0, 22.0 ],
									"text" : "deferlow"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 654.0, 290.0, 77.0, 22.0 ],
									"text" : "route symbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 654.0, 319.0, 115.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 654.0, 349.0, 51.0, 22.0 ],
									"text" : "pcontrol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 654.0, 261.0, 50.5, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 568.0, 792.0, 115.0, 22.0 ],
									"text" : "prepend loadunique"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 568.0, 820.0, 51.0, 22.0 ],
									"text" : "pcontrol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 610.0, 753.0, 143.0, 22.0 ],
									"text" : "Stochastic_gates.maxpat"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 161.0, 640.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 161.0, 602.0, 96.0, 22.0 ],
													"text" : "prepend append"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 37.5, 591.0, 79.0, 22.0 ],
													"text" : "prepend tabs"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 37.5, 552.0, 233.0, 22.0 ],
													"text" : "zl.group"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 37.5, 628.0, 30.0, 30.0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-44", 0 ],
													"midpoints" : [ 26.5, 540.5, 47.0, 540.5 ],
													"source" : [ "obj-14", 0 ]
												}
...
,
									"patching_rect" : [ 614.0, 152.0, 99.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 614.0, 31.5, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 614.0, 120.0, 115.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 579.5, 661.0, 160.0, 22.0 ],
									"text" : "flowSwing_envelop.maxhelp"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 500.0, 262.0, 39.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 175.0, 367.0, 454.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 568.0, 611.0, 175.0, 22.0 ],
									"text" : "flowSwing_audioWarp.maxhelp"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 425.0, 186.0, 23.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 17.0, 319.0, 186.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 455.0, 262.0, 39.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 175.0, 344.0, 454.0, 23.0 ],
									"text" : "Time-warping audio samples by aligning warp markers to an NI Grid."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 109.0, 260.0, 21.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 15.0, 109.0, 260.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 39.0, 876.0, 418.0, 36.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 19.0, 916.0, 369.0, 36.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 124.0, 822.0, 371.0, 36.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "bang", "bang", "" ],
									"patching_rect" : [ 19.0, 797.0, 59.0, 22.0 ],
									"text" : "sel 0 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 742.0, 152.0, 289.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 757.0, 231.0, 35.0, 22.0 ],
									"text" : "clear"
								}
...
,
		...
		"parameters" : 		{
			"obj-7::obj-20::obj-109" : [ "breakpoints[1]", "breakpoints", 2 ],
...
,
			"parameter_overrides" : 			{
				"obj-7::obj-20::obj-114" : 				{
					"parameter_longname" : "clear_breakpoints[1]"
				}
,
				"obj-7::obj-20::obj-128" : 				{
...
, 			{
				"name" : "icon.png",
				"bootpath" : "~/Documents/Max 9/Packages/FlowSwing-Max-MSP",
				"patcherrelativepath" : "..",
				"type" : "PNG",
				"implicit" : 1
			}
				...
				"valuedictionary" : 				{
					"parameter_values" : 					{
						...
						"blob" : 						{
							...
							"asGrid" : [ 0.16, 0, 2 ],
							"breakpoints[1]" : [ 								{
									"env" : [ 0, 1, 0, 0.248, 0.560734230456972, 0, 0.416, 0.398416426903638, 0, 0.664, 0.855857509644852, 0, 1, 1, 0 ],
									"lock" : 									{
										"associations" : [ 0, 1, 2, 3, 5 ],
										"order" : [ 0, 0, 0, 0, 0 ]
									}
							...
							"valuedictionary" : 							{
								"parameter_values" : 								{
									...
									"blob" : 									{
										...
										"asGrid" : [ 0.3, 0, 5 ],
										"breakpoints[1]" : [ 											{
												"env" : [ 0, 1, 0, 0.295, 0.59024655837576, 0, 0.53, 0.903225806451613, -0.005, 0.6775, 0.708295870050912, 0.245, 0.765, 0.44268491878182, 0, 1, 1, 0 ],
												"lock" : 												{
													"associations" : [ 0, 2, 4, 5, 6, 8 ],
													"order" : [ 0, 0, 0, 0, 0, 0 ]
												}
							...
							"valuedictionary" : 							{
								"parameter_values" : 								{
									...
									"blob" : 									{
										...
										"asGrid" : [ 1.0, 3, 9 ],
										"breakpoints[1]" : [ 											{
												"env" : [ 0, 1, 0, 0.117204766312908, 0.29512327918788, 0, 0.222222222222222, 0.634515050253942, 0, 0.344193817878028, 0.354147935025456, 0, 0.444444444444444, 0.66402737817273, 0, 0.581576671913934, 0.250854787309698, 0, 0.666666666666667, 0.826345181726064, -0.005, 0.782549679310439, 0.250854787309698, 0, 0.895499657032175, 0.354147935025456, 0, 1, 1, 0 ],
												"lock" : 												{
													"associations" : [ 0, 1, 1, 2, 2, 3, 3, 3, 4, 4 ],
													"order" : [ 0, 1, 0, 1, 0, 1, 0, 2, 1, 0 ]
												}
							...
							"valuedictionary" : 							{
								"parameter_values" : 								{
									...
									"blob" : 									{
										...
										"asGrid" : [ 1.0, 0, 8 ],
										"breakpoints[1]" : [ 											{
												"env" : [ 0, 1, 0, 0.375, 1, 0, 0.75, 1, 0, 1, 1, 0 ],
												"lock" : 												{
													"associations" : [ 0, 1, 2, 3 ],
													"order" : [ 0, 0, 0, 0 ]
												}

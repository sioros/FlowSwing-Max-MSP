        ...
        "boxes": [
            {
                "box": {
                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 49.0, 144.0, 101.0, 22.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 2,
                                    "outlettype": [ "", "" ],
                                    "patching_rect": [ 102.0, 176.0, 107.0, 22.0 ],
                    ...
                    "patching_rect": [ 263.0, 117.0, 19.0, 22.0 ],
                    "text": "p"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 750.0, 305.0, 71.0, 22.0 ],
                    "text": "route active"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 4,
                    "outlettype": [ "", "", "", "" ],
                    "patching_rect": [ 227.0, 63.5, 57.0, 36.0 ],

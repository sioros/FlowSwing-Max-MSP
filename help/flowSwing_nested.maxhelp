...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 7.0, 8.0, 426.0, 101.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"text" : "Control the nested NI Grids parameters in real time through the UI or via messages to the right outlet"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 622.0, 167.0, 171.0, 48.0 ],
									"text" : "Locking the breakpoints on the NI Grid matches each grid point to the nearest NI beat"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 320.625, 486.600004285573959, 577.5, 486.600004285573959 ],
									"order" : 0,
									"source" : [ "obj-1", 1 ]
								}
...
,
		...
		"parameters" : 		{
			...
			"obj-21::obj-1::obj-52" : [ "clear_breakpoints[4]", "clear_breakpoints", 0 ],
...
, 			{
				"name" : "flowSwing_nested.maxhelp.maxsnap",

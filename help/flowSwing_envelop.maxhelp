...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 761.0, 80.0, 123.0, 62.0 ],
					"text" : "change the numebr of mc channels used for sequencing. The default is 64."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "sequencer and cotnrol signal generator"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 882.0, 149.0, 75.0, 22.0 ],
					"text" : "getattributes"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 803.0, 149.0, 51.0, 22.0 ],
					"text" : "chans 8"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 229.0, 189.0, 672.0, 228.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 571.0, 497.0, 136.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 479.0, 150.0, 89.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 381.0, 138.0, 150.0, 75.0 ],
									"text" : "When two breakpoints coincide in time, this restrict the duration of the gate pulse to a minimum duration."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 235.0, 464.0, 142.0, 22.0 ],
...
,
					"patching_rect" : [ 381.0, 455.0, 102.0, 22.0 ],
					"text" : "p \"mc sequencer\""
				}
...
,
					"patching_rect" : [ 229.0, 447.0, 47.0, 22.0 ],
					"text" : "p noise"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 69.0, 434.0, 150.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 920.0, 256.0, 135.0, 22.0 ],
					"priority" : 					{
						"flowSwing_envelop::morph" : 1,
						"flowSwing_envelop::S" : 1,
						"flowSwing_envelop::lock" : 2
					}
,
					"saved_object_attributes" : 					{
						"client_rect" : [ 443, 261, 851, 502 ],
						"parameter_enable" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 920.0, 285.0, 150.0, 89.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 709.0, 434.0, 132.0, 117.0 ],
					"text" : "The gate signal at the second outlet can be used for sample accurate sequencing. Each channel of the mc signal correpsonds to a single breakpoint of the envelop "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 362.0, 112.0, 158.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 340.0, 167.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"saved_attribute_attributes" : 					{
						"bgcolor" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 556.0, 150.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"saved_attribute_attributes" : 					{
						"bgcolor" : 						{
							"expression" : "themecolor.theme_syntax_objectcolor"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 180.0, 354.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"saved_attribute_attributes" : 					{
						"bgcolor" : 						{
							"expression" : "themecolor.theme_syntax_objectcolor"
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 323.0, 170.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 180.0, 252.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"saved_attribute_attributes" : 					{
						"bgcolor" : 						{
							"expression" : "themecolor.theme_syntax_objectcolor"
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 69.0, 150.0, 150.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 910.0, 193.0, 150.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 238.0, 167.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 578.0, 118.0, 150.0, 62.0 ],
					"text" : "Locking the breakpoints on the NI Grid matches each grid point to the nearest Fromative beat"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 76.0, 94.0, 143.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 229.0, 96.0, 64.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : "themecolor.theme_bgcolor"
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "signal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 381.0, 497.0, 136.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 47.0, 493.0, 121.0, 22.0 ],
									"text" : "*~ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 47.0, 442.0, 93.0, 36.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 46.5, 323.0, 35.0, 22.0 ],
									"text" : "sah~"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 149.0, 320.0, 153.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "bang" ],
									"patching_rect" : [ 149.0, 415.0, 99.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 315.0, 140.0, 70.0, 22.0 ],
									"text" : "read bd+hh"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 149.0, 171.0, 40.0, 22.0 ],
									"text" : "mc.*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 170.0, 139.0, 55.0, 22.0 ],
									"text" : "mc.>~ 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 170.0, 103.0, 74.0, 22.0 ],
									"text" : "mc.change~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 149.0, 203.0, 92.0, 22.0 ],
									"text" : "mc.mixdown~ 1"
								}
...
,
					"patching_rect" : [ 571.0, 455.0, 121.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 229.0, 154.0, 72.0, 22.0 ],
					"text" : "phasor~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.0, 603.0, 72.0, 22.0 ],
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 350.0, 635.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 320.125, 429.5, 390.5, 429.5 ],
					"order" : 1,
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 320.125, 429.600004285573959, 580.5, 429.600004285573959 ],
					"order" : 0,
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 580.5, 602.100004285573959, 375.5, 602.100004285573959 ],
					"order" : 0,
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 580.5, 590.100004285573959, 359.5, 590.100004285573959 ],
					"order" : 1,
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-19", 1 ],
					"midpoints" : [ 238.5, 588.600006729364395, 375.5, 588.600006729364395 ],
					"order" : 0,
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-19", 1 ],
					"midpoints" : [ 390.5, 586.000006228685379, 375.5, 586.000006228685379 ],
					"order" : 0,
					"source" : [ "obj-90", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-19", 0 ],
					"midpoints" : [ 390.5, 585.000006228685379, 359.5, 585.000006228685379 ],
					"order" : 1,
					"source" : [ "obj-90", 0 ]
				}

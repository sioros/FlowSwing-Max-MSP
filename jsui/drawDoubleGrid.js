...
var levels = [];
var ptrn = [];
var grid1 = [-1., -.5, 0., 0.5, 1];
var grid2 = [-1., -.5, 0., 0.5, 1];
var dir = 1;
var mar = 0.01;
// process arguments
...
function list()
{
	...
	case 0:	
    	...
    	for (i = 0 ; i < len ; i++)
    	{
    		grid1[i] = arguments[i]*2.-1.;
    	}
		grid1[i] = arguments[0]*2.-1.+2.;
		outlet(0,grid1);
	...
	case 1:
    	...
    	for (i = 0 ; i < len ; i++)
    	{
    		grid2[i] = arguments[i]*2.-1.;
    	}
		grid2[i] = arguments[0]*2.-1.+2.;
		outlet(0,grid2);
...
function draw()
{
	...
	with (sketch) {
		...
		for (i=0; i<grid1.length; i++)
		{
			...
			moveto(grid2[i]*asp,-dir);
			gllinewidth(LineWidth);
				
			lineto(grid1[i]*asp,dir);

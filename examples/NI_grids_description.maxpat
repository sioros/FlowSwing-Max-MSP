...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 225.0, 261.0, 150.0, 34.0 ],
					"text" : "L: Long interval\nS: Short interval"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 19.0, 15.0, 323.0, 34.0 ],
...
,
					"patching_rect" : [ 677.0, 298.0, 115.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 100.0, 267.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 100.0, 292.0, 183.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 225.0, 199.0, 593.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 672.0, 108.0, 146.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 672.0, 70.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 652.0, 36.0, 173.0, 22.0 ],
					"text" : "loadmess patcher offset 0 -135"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 159.0, 168.0, 673.0, 94.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 220.0, 23.022416979074478, 20.901335656642914 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 213.0, 125.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 198.0, 23.022416979074478, 20.901335656642914 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 100.0, 191.0, 33.0, 20.0 ],
					"text" : "Shift"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 241.0, 23.022416979074478, 20.901335656642914 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 59.0, 234.0, 74.0, 20.0 ],
					"text" : "Target pulse"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 174.0, 23.022416979074478, 20.901335656642914 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 39.0, 167.0, 94.0, 20.0 ],
...
, 			{
				"name" : "NI_grids_description.maxsnap",
...
,
			"snapshotlist" : 			{
				...
				"entries" : [ 					{
						...
						"version" : 2,
						"minorversion" : 0,
						"name" : "NI_grids_description_samba_prefered",
						"origin" : "NI_grids_description",
						"type" : "patcher",
						"subtype" : "Undefined",
						"embed" : 1,
						"snapshot" : 						{
...
,
						"fileref" : 						{
							"name" : "NI_grids_description",
							"filename" : "NI_grids_description.maxsnap",
							"filepath" : "~/Documents/Max 9/Snapshots",
							"filepos" : -1,
							"snapshotfileid" : "8438e2d8eac05caf09173235de818151"
						}

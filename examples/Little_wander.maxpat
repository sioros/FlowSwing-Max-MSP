{
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 344.0, 632.5, 73.0, 20.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 301.0, 119.0, 73.0, 20.0 ],
                    "text": "Start Audio"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 364.5, 108.0, 275.0, 48.0 ],
                    "presentation": 1,
                    "presentation_linecount": 3,
                    "presentation_rect": [ 442.0, 99.0, 274.0, 48.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "presentation": 1,
                    "presentation_rect": [ 17.0, 119.0, 107.0, 20.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 609.0, 290.0, 70.0, 20.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 442.0, 151.0, 70.0, 20.0 ],
                    "text": "Wandering"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "presentation": 1,
                    "presentation_rect": [ 571.0, 151.0, 44.0, 20.0 ],
                    "text": "Mode"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "presentation": 1,
                    "presentation_rect": [ 523.0, 151.0, 31.0, 21.0 ],
                    "saved_attribute_attributes": {
                        "valueof": {
                            "parameter_enum": [ "val1", "val2" ],
            ...
            },
            {
                "box": {
                    ...
                    "presentation": 1,
                    "presentation_rect": [ 618.0, 153.0, 84.0, 17.0 ],
                    "saved_attribute_attributes": {
                        "activebgcolor": {
                            "expression": ""
                        },
            ...
            },
            {
                "box": {
                    ...
                    "presentation": 1,
                    "presentation_rect": [ 66.0, 150.0, 44.0, 19.0 ],
                    "saved_attribute_attributes": {
                        "valueof": {
                            "parameter_enum": [ "val1", "val2" ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 208.0, 93.0, 122.0, 20.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 158.0, 149.5, 122.0, 20.0 ],
                    "text": "Cycles/Minute (CPM)"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "presentation": 1,
                    "presentation_rect": [ 112.0, 152.0, 44.0, 15.0 ],
                    "saved_attribute_attributes": {
                        "valueof": {
            ...
            {
                "box": {
                    "activebgcolor": [ 0.7215686274509804, 0.3803921568627451, 0.3803921568627451, 1.0 ],
                    ...
                    "presentation": 1,
                    "presentation_rect": [ 17.0, 150.0, 44.0, 19.0 ],
                    "saved_attribute_attributes": {
                        "activebgcolor": {
                            "expression": ""
                        },
            ...
            },
            {
                "box": {
                    ...
                    "presentation": 1,
                    "presentation_rect": [ 323.0, 140.0, 29.0, 29.0 ]
                }
            },
            {
                "box": {
        ...
        "parameters": {
            ...
            "obj-10::obj-164": [ "Target_div", "Target_div", 0 ],
            "obj-10::obj-165": [ "Formative_div", "Formative_div", 0 ],
            "obj-10::obj-174": [ "S_div", "S_div", 0 ],
            ...
            "obj-12::obj-209": [ "zoom_y_control", "zoom_y_control", 0 ],
            ...
            "snapshot": {
                "valuedictionary": {
                    "parameter_values": {
                        ...
                        "S": 0.10622444262783012,
                        "S[2]": 0.10622444262783012,
                        "blob": {
                            "buffer": [ "loop" ],
                            "title": [ "Synth" ],
                            "title[1]": [ "FlowSwing" ],
                            "zoom": [ 1.0 ],
                            "zoom[2]": [ 1.0 ],
                            "zoom_y_control": [ 1.0000000000000004 ],
